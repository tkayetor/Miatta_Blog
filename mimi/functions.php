<?php
/**
 * Mimi\'s Style functions and definitions
 *
 * @link https://developer.wordpress.org/themes/basics/theme-functions/
 *
 * @package Mimi\'s_Style
 */
...
function mimi_setup() {
	 ...
	 * If you're building a theme based on Mimi\'s Style, use a find and replace
...
function mimi_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'mimi' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'mimi' ),
...
function mimi_scripts() {
	...
	wp_enqueue_script( 'mimi-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'mimi-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
